...
public class MainController extends BaseController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        currentClassObject = Payment.class;
        Client.setTextArea(textArea);

        List<Payment> list = Client.get("payment", Payment[].class).build();
        TableColumnsGenerator.setTableView(table).generateColumns(list, Payment.class);
    ...
    private void buttonsHandler() {
        ...
        butPayment.addEventFilter(MouseEvent.MOUSE_CLICKED, this::buttonObjectHandler);
        butSubscribers.addEventFilter(MouseEvent.MOUSE_CLICKED, this::buttonObjectHandler);
    }
